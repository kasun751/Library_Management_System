...
import LoginIcon from "../assets/LoginManIcon.svg";
import SLMSLogo from "../assets/SLMS-mini-logo.png";
import { logoutFun } from '../../../logoutFun';

function HeaderComponent({id,Link1,text,router1,Link2,router2, Link3,router3, Link4,router4,Link5,router5,Link6,router6,Link7,router7}) {
    return (
