...
import submitPost from '../../Images/submit-post.svg';
...
function SubmitPostForm({ category: initialCategory = 'none', title: initialTitle = '', description: initialDescription = '', formAvailable: initialformAvailable = false, btn_value: initialbtn_value = 'Send Post', post_id }) {
    ...
    const validateImgFiles = () =>{
        ...
        const allowedFileTypes = ["image/jpeg","image/jpg","image/png","image/gif","image/svg+xml","image/svg"]
        ...
        <div className='main-submit'>
            {formAvailable && (
                <div className='container submitPostFormBox col-lg-6'>
                    ...
                    <div className="row">
                        <div >
                            <img id='submitForm-back-btn' src={arrowRight} onClick={handleToHideCreatePostForm} alt="Arrow" />
                        </div>
            ...
            <div className='submitPostFormBtn'>
                {!formAvailable && initialbtn_value === 'Send Post' && <img src={submitPost} alt="submit Post" onClick={handleToCreatePost} />}
            </div>
        </div>
    );
}
