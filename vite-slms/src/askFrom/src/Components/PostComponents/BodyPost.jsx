...
import saveBtn from '../../Images/save.svg'; 
import unSaveBtn from '../../Images/unSave.svg'; 
import enlargeBtn from '../../Images/view-in-body.svg'; 
import editBtn from '../../Images/edit-btn.svg'; 
import reportBtn from '../../Images/report-btn.svg'; 
...
function BodyPost({ post}) {
  ...
  const img = savePost? saveBtn : unSaveBtn;
      ...
      <div className=' postComponent col-lg-12 col-sm-12 col-12'>
        <div className='image-box'>
          <div className='post-btn-panel'>
              ...
              {!isAvailable && 
              <img id = "reportBtn" src={reportBtn} alt="report"  onClick={handleReport} data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip" data-bs-title="Report" 
              title='Report'/>
              }

              {isAvailable && 
              <img id="editPostBtn" src={editBtn} alt="edit" onClick={handleEdit}  data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip" data-bs-title="Edit" title='Edit' />
              }
              ...
              {isAvailable && <img id="deletePostBtn" src={delBtn} alt="delete" onClick={handleDelete} data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip" data-bs-title="Save" title='Delete'/>}
          </div>
            <div className='imageSlider-container'>
              
          <img id="enlarge-btn" src={enlargeBtn} alt="view images" onClick={()=>setOpenEnlarger(true)} />
