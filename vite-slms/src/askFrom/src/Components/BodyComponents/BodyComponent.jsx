...
import scrollBtn from '../../Images/scroll-up-btn.svg';
    ...
    <loadPanelPost.Provider value = {{setPost_id, showPanelPost, setShowPanelPost}}>
      <postRefresh.Provider value={{refresh, handleRefresh}}>
        ...
        <div id='selectList-container'>
            ...
            <div id='post-numbers'>
              <img src={prevBtn} onClick={()=>onClickSetOffSet(-5)} />
              <p>Posts {offSet+1} to {offSet+5}</p>
              <img src={nextBtn} onClick={()=>onClickSetOffSet(5)} />
          </div>
          </div>
        ...
        <div id="scroll-btn-container">
          <img src={scrollBtn} alt="scroll up" id='scroll-btn' onClick={()=>window.scrollTo(0,0)}/>
        </div>
