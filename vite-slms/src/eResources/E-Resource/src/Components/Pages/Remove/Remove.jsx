...
const Remove = () => {
  ...
  useEffect(() => {
    ...
    const confirmDelete = async () => {
        try {
            const res = await axios.post(
                'http://localhost:80/project_1/E-Resource_Php/Controllers/RemoveBookController.php',
                deleteBook,
                {
                    headers: {
    ...
    return (
        <div>
            <HeaderComponent
                id="homePageHeader" router1={"/eresource"} Link1={"Home"} router2={"/dashboard"} Link2={"DashBoard"}
                router3={"/logout"} Link3={"Log Out"}
            />
            ...
            <Modal show={showModal} onHide={() => setShowModal(false)}>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="danger" onClick={confirmDelete} href="/ebook">
                        Yes
                    </Button>
                </Modal.Footer>
            </Modal>
