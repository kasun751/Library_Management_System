  ...
  useEffect(() => {
    ...
    useEffect(() => {
        const fetchNextId = async () => {
            try {
                const res = await axios.get("http://localhost:80/project_1/E-Resource_Php/Controllers/GetNewsPapersNextIdController.php");
    ...
    const updateDatabase = async () => {
        ...
        try {
            ...
            const res = await axios.post(
                'http://localhost:80/project_1/E-Resource_Php/Controllers/AddNewsPapersController.php',
                formDataToSend,
                {
                    headers: {
    ...
    return(
        <>
            <HeaderComponent
                ...
                router2={"/dashboard"} Link2={"DashBoard"} router7={"/logout"} Link7={"Log Out"}
            />
