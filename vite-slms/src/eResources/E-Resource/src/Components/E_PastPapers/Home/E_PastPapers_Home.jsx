        ...
        const getViewPastPapersDetails = async () => {
            try {
                const res = await axios.get(
                    'http://localhost:80/project_1/E-Resource_Php/Controllers/ViewPastPapersDetailsContoller.php',
                    {
                        headers: {
                ...
                <div className="row d-flex justify-content-center">
                    {filteredPapers.map((papers, index) => (
                        <PapersCard
                            ...
                            image_path={`http://localhost:80/project_1/PastPapersIMAGES/${papers.image_path}`}
                            pdf_path={`http://localhost:80/project_1/PastPapersPDF/${papers.pdf_path}`}
                        />
                    ))}
                </div>
            </div>
