...
function ViewBookRequests() {
    ...
    useEffect(() => {
        const fetchBooks = async () => {
            await axios.get('http://localhost:80/project_1/UserLogin/controllers/HandleRequestController.php')
                .then(response => {
    ...
    const getRequestDetails = async (userID) => {
        const res = await axios.post(
            'http://localhost:80/project_1/UserLogin/controllers/HandleRequestController.php?id=1',
            userID,
            {
                headers: {
