...
function CheckIn(){
    ...
    const getReturnBookIdDetails = async (bookID) => {
        ...
        await axios.get('http://localhost:80/project_1/UserLogin/controllers/ReturnBookController.php', {
            params: {
    ...
    const returnBook = async () => {
        ...
        const res = await axios.post(
            'http://localhost:80/project_1/UserLogin/controllers/ReturnBookController.php',
            extendedData,
            {
                headers: {
            ...
            <div id="checkIn" className="bookSectionCommonClass">
                ...
                <div id="formDivReturnBook" className="bookSectionCommonFormClass">
                    <form className="row g-3 needs-validation" noValidate>
                        <h1>Book Check-In</h1>
                        <p style={{
                            color: returnMessage === "Successfully Returned!" ? 'yellow' : 'red',
                        }}>{returnMessage}</p>
                        <div className="row justify-content-center">
                            ...
                            <p>Fine Calculation: RS. {returnBookIdDetails.fine}</p>
