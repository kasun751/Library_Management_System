...
function AddRemoveCategory() {
    ...
    const updateDatabase = async (access) => {
        ...
        const res = await axios.post(
            'http://localhost:80/project_1/UserLogin/controllers/CategoryController.php',
            extendedData,
            {
                headers: {
                    ...
                    <div>
                        {addMessage && (
                            <p
                                ...
                                style={{
                                    display: 'initial',
                                    color: addMessage === "Category Added Successfully." ? 'yellow' : 'red',
                                }}
                            >
                                {addMessage}
                            </p>
                    ...
                    <div>
                        {removeMessage && removeMessage !== 'tableNotEmpty' && (
                            <p
                                ...
                                style={{
                                    display: 'initial',
                                    color: removeMessage === "Category remove Successfully." ? 'Yellow' : 'red',
                                }}
                            >
                                {removeMessage}
                            </p>
