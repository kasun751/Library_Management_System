...
import { isAdmin, isLibrarian } from "../../../../userAuthFun.jsx";

function RegisterStaffUser() {
    const [inputs, setInputs] = useState({});
    const [nextUserID] = useState({});
                ...
                <div>
                    <RegistrationCommonForm handleChange={handleChange} submit={submit}
                        ...
                        <select className="form-select"
                            ...
                            {isAdmin() && <option value="Librarian">Librarian
                            </option>}
                            {isLibrarian() && <option
                    ...
                    </div>} birthDate={birthDate} gender={gender}/>
                </div>
            </div>
            <FooterComponent/>
        </div>)
...
export default RegisterStaffUser;