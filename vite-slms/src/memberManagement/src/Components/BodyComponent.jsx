...
import { isAdmin, isLibrarian } from '../../../userAuthFun';
...
function BodyComponent() {
    ...
    return (
        <div className='main-memberManage'>
            ...
            <button className='btn btn-primary summary-btn' data-bs-toggle="modal" data-bs-target="#summaryReport" onClick={()=>{handleGetSummaryData(),setIsFade(true)}} >Summary</button>
  ...
  const isRestricted = item.Account_Status === 2;
  let isAdminOrLib = ['ADM', 'LIB'].includes(item.UserID.split('/')[1]);
  const isLib = ['LIB'].includes(item.UserID.split('/')[1]);
    ...
    <tr key={index}>
      ...
      <td className="btn-group">
        <button
          ...
          onClick={() => handleAction(item.UserID)}
          disabled={loading || NotLibraian || isAdminOrLib}
        >
          Edit
        </button>
        ...
        <button
          ...
          data-bs-toggle="modal"
          data-bs-target="#viewMoreDetails"
          onClick={() => handleAction(item.UserID)}
          disabled={loading}
        >
          More...
        ...
        <button
          className={`btn ${isRestricted ? 'btn-warning' : 'btn-outline-warning'}`}
          data-bs-toggle="modal"
          data-bs-target={isRestricted ? '#removeRestriction' : '#restrictedReason'}
          onClick={() => handleAction(item.UserID)}
          disabled={loading || NotLibraian || isAdminOrLib}
        >
          {isRestricted ? 'Restricted' : 'Restrict__'}
        </button>
        ...
        >
          Delete
            ...
            {
                <div className="modal fade" id="editFormModel" data-bs-backdrop="static" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                ...
                                <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={()=>{updateUserInfo(formData.user_id),setIsFade(false)}}>Save changes</button>
                            </div>
                        </div>
                    </div>
                </div>
             ...
             {
                <div className="modal fade" id="viewMoreDetails" data-bs-backdrop="static" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h1 className="modal-title fs-5" id="exampleModalLabel">Edit Member Details</h1>
            ...
            {
                <div className="modal fade" id="restrictedReason" data-bs-backdrop="static" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header">
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={()=>setIsFade(false)}>Close</button>
                                <button type="button" className="btn btn-warning" data-bs-dismiss="modal" onClick={()=>{handleRestrict(formData.user_id,formData.reason),setIsFade(false)}}>Restrict</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {
                <div className="modal fade" id="removeRestriction" data-bs-backdrop="static" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header">
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={()=>setIsFade(false)}>Close</button>
                                <button type="button" className="btn btn-warning" data-bs-dismiss="modal" onClick={()=>{handleRemoveRestrict(formData.user_id),setIsFade(false)}}>Remove Restrictions</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {
                <div className="modal fade" id="confirmDelete" data-bs-backdrop="static" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            <div className="modal-header">
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={()=>setIsFade(false)}>Cancel</button>
                                <button type="button" className="btn btn-danger" data-bs-dismiss="modal" onClick={()=>{handleDelete(formData.user_id),setIsFade(false)}}>Yes</button>
                            </div>
                        </div>
                    </div>
                </div>
