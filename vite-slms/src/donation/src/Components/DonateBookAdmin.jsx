    ...
    <div className='main-donateBookAdmin m-2'>
         <Card style={{ width: '18rem' }}>
            <Card.Body>
                ...
                <Card.Link >
                    <button type="button" className="btn btn-outline-info" data-bs-toggle="modal" data-bs-target={`#donationsInfo${count}`} onClick={()=>setIsFade(true)}>Details</button>
                </Card.Link>
            </Card.Body>
        </Card>
        ...
        <div className="modal fade" id={`donationsInfo${count}`} data-bs-backdrop="static" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
