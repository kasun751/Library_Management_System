...
function Home() {
    return (
        ...
        <div className="body">
            ...
            <div className="home mx-auto" style={{border:"1px solid white",backgroundColor:"white",width:"92vw",padding:"0 40px"}}>

                <div className="card-title mt-5">E-BOOKS SECTION</div>
                ...
                <div className="card mb-5 border-0">
                    <div className="row g-0">
                        ...
                        <div className="col-md-5  d-flex flex-column justify-content-center mx-auto">
                            <div className="card-body">

                                <p className="card-text"><small>Welcome to our E-Book Section, offering a wide range of
                                    digital books
                                    across various genres and topics. Enjoy seamless access to your favorite titles
                                    anytime, anywhere, enhancing your reading experience and supporting your literary
                                    journey.</small></p>
                                <div className="col-md-5 mt-2">
                                    <button className="btn btn-outline-success button" id="custom-button" type="submit">
                ...
                <div className="card-title">E-NEWSPAPERS SECTION</div>
