...
class UpdatePastPapersController{
    ...
    public function UpdatePastPaper(){
        if (isset($_POST['id'])) {
            $id = $_POST['id'];
...
//            $stmt->close();
            ...
            $result=$this->ePastPaperObj->GetPath($id);
...
//            $stmt->bind_param('sssssss', $subject,  $grade,$year, $extra, $newFileName, $newFileName1, $id);
            ...
            $result=$this->ePastPaperObj->UpdatePastPaper($subject,  $grade,$year, $extra, $newFileName, $newFileName1, $id);
...
$updatePastPaperObj=new UpdatePastPapersController();
$updatePastPaperObj->UpdatePastPaper();
