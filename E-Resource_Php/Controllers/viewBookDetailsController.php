...
class viewBookDetailsController{
    private $eBookObj;
...
//        $totalPages = ceil($totalBooks / $limit);
        $totalPages=$this->eBookObj->GetTotalPages($limit);
...
//$result = $conn->query($sql);
        ...
        $result=$this->eBookObj->ViewBookDetails($limit, $offset);
...
$viewBookDetailsObj=new viewBookDetailsController();
$viewBookDetailsObj->viewBookDetails();
