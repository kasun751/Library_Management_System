...
//                    $stmt->bind_param('sssssss',  $id, $subject,$grade, $year, $extra ,$newFileName1, $newFileName);
                    $result=$this->ePastPaperObj->AddPastPaper($id, $subject,$grade, $year, $extra ,$newFileName1, $newFileName);
...
$addPastPaperControllerObj=new AddPastPapersController();
$addPastPaperControllerObj->AddpastPaper();
?>
