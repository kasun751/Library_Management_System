...
class AddNewBook
{
    ...
    {   //insert new books details to book table
        ...
        $query1 = "INSERT INTO books (ISBN_Number,BookName, AuthorName, PublisherName,Category,BookLocation,Description) VALUES ('$isbnNumber', '$bookName', '$authorName', '$publisherName ', '$category','$bookLocation', '$description')";
